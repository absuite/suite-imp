...
If OBJECT_ID(N'P_ISV_TRANSDATA_TRADE_RCV', N'P') IS NOT NULL Drop PROCEDURE P_ISV_TRANSDATA_TRADE_RCV;
Go

Create PROCEDURE P_ISV_TRANSDATA_TRADE_RCV
(	
...
Begin
	/*
	采购收货
	Exec P_ISV_TRANSDATA_TRADE_RCV
	*/
	...
	Set @SQL=@SQL+'	Where h.ReceivementType=0 ';
